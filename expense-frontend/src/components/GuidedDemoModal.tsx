    ...
    >
      <div className="w-full max-w-lg rounded-2xl bg-card shadow-xl border p-6">
        <div className="flex items-start justify-between gap-3">
          <div>
            <h2 id="guided-demo-title" className="text-lg font-semibold text-foreground">
              Guided Demo
            </h2>
            <p className="text-sm text-muted-foreground mt-1">
              This is a public demo. Data resets daily. Don&apos;t enter sensitive information.
            </p>
          </div>
          <button
            onClick={close}
        ...
        {error && (
          <div className="mt-4 text-sm text-red-700 bg-red-50 border border-red-100 rounded-lg px-3 py-2" role="alert">
            {error}
          </div>
        )}
